...
import com.example.yann.classroom_community.FriendFragment.OnListFragmentInteractionListener;
...
public class MyFriendRecyclerViewAdapter extends RecyclerView.Adapter<MyFriendRecyclerViewAdapter.ViewHolder> {
    ...
    private final List<FriendContent.Friend> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyFriendRecyclerViewAdapter(List<FriendContent.Friend> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onFriendFragmentInteraction(holder.mItem);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public FriendContent.Friend mItem;
